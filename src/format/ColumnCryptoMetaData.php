...
class ColumnCryptoMetaData
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\jocoon\parquet\format\EncryptionWithFooterKey',
        ),
        2 => array(
            'var' => 'ENCRYPTION_WITH_COLUMN_KEY',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\jocoon\parquet\format\EncryptionWithColumnKey',
        ),
    );

    /**
     * @var \jocoon\parquet\format\EncryptionWithFooterKey
     */
    public $ENCRYPTION_WITH_FOOTER_KEY = null;
    /**
     * @var \jocoon\parquet\format\EncryptionWithColumnKey
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->ENCRYPTION_WITH_FOOTER_KEY = new \jocoon\parquet\format\EncryptionWithFooterKey();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->ENCRYPTION_WITH_COLUMN_KEY = new \jocoon\parquet\format\EncryptionWithColumnKey();
