...
class LogicalType
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\StringType',
        ),
        2 => array(
            'var' => 'MAP',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\MapType',
        ),
        3 => array(
            'var' => 'LIST',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\ListType',
        ),
        4 => array(
            'var' => 'ENUM',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\EnumType',
        ),
        5 => array(
            'var' => 'DECIMAL',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\DecimalType',
        ),
        6 => array(
            'var' => 'DATE',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\DateType',
        ),
        7 => array(
            'var' => 'TIME',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\TimeType',
        ),
        8 => array(
            'var' => 'TIMESTAMP',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\TimestampType',
        ),
        10 => array(
            'var' => 'INTEGER',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\IntType',
        ),
        11 => array(
            'var' => 'UNKNOWN',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\NullType',
        ),
        12 => array(
            'var' => 'JSON',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\JsonType',
        ),
        13 => array(
            'var' => 'BSON',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\BsonType',
        ),
        14 => array(
            'var' => 'UUID',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\UUIDType',
        ),
    );

    /**
     * @var \codename\parquet\format\StringType
     */
    public $STRING = null;
    /**
     * @var \codename\parquet\format\MapType
     */
    public $MAP = null;
    /**
     * @var \codename\parquet\format\ListType
     */
    public $LIST = null;
    /**
     * @var \codename\parquet\format\EnumType
     */
    public $ENUM = null;
    /**
     * @var \codename\parquet\format\DecimalType
     */
    public $DECIMAL = null;
    /**
     * @var \codename\parquet\format\DateType
     */
    public $DATE = null;
    /**
     * @var \codename\parquet\format\TimeType
     */
    public $TIME = null;
    /**
     * @var \codename\parquet\format\TimestampType
     */
    public $TIMESTAMP = null;
    /**
     * @var \codename\parquet\format\IntType
     */
    public $INTEGER = null;
    /**
     * @var \codename\parquet\format\NullType
     */
    public $UNKNOWN = null;
    /**
     * @var \codename\parquet\format\JsonType
     */
    public $JSON = null;
    /**
     * @var \codename\parquet\format\BsonType
     */
    public $BSON = null;
    /**
     * @var \codename\parquet\format\UUIDType
     */
    public $UUID = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->STRING = new \codename\parquet\format\StringType();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->MAP = new \codename\parquet\format\MapType();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->LIST = new \codename\parquet\format\ListType();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->ENUM = new \codename\parquet\format\EnumType();
                ...
                case 5:
                    if ($ftype == TType::STRUCT) {
                        $this->DECIMAL = new \codename\parquet\format\DecimalType();
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->DATE = new \codename\parquet\format\DateType();
                ...
                case 7:
                    if ($ftype == TType::STRUCT) {
                        $this->TIME = new \codename\parquet\format\TimeType();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->TIMESTAMP = new \codename\parquet\format\TimestampType();
                ...
                case 10:
                    if ($ftype == TType::STRUCT) {
                        $this->INTEGER = new \codename\parquet\format\IntType();
                ...
                case 11:
                    if ($ftype == TType::STRUCT) {
                        $this->UNKNOWN = new \codename\parquet\format\NullType();
                ...
                case 12:
                    if ($ftype == TType::STRUCT) {
                        $this->JSON = new \codename\parquet\format\JsonType();
                ...
                case 13:
                    if ($ftype == TType::STRUCT) {
                        $this->BSON = new \codename\parquet\format\BsonType();
                ...
                case 14:
                    if ($ftype == TType::STRUCT) {
                        $this->UUID = new \codename\parquet\format\UUIDType();
