...
class TimeType
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\TimeUnit',
        ),
    );
    ...
    /**
     * @var \codename\parquet\format\TimeUnit
     */
    public $unit = null;
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->unit = new \codename\parquet\format\TimeUnit();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('TimeType');
