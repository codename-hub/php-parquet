...
class TimeUnit
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\MilliSeconds',
        ),
        2 => array(
            'var' => 'MICROS',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\MicroSeconds',
        ),
        3 => array(
            'var' => 'NANOS',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\NanoSeconds',
        ),
    );

    /**
     * @var \codename\parquet\format\MilliSeconds
     */
    public $MILLIS = null;
    /**
     * @var \codename\parquet\format\MicroSeconds
     */
    public $MICROS = null;
    /**
     * @var \codename\parquet\format\NanoSeconds
     */
    public $NANOS = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->MILLIS = new \codename\parquet\format\MilliSeconds();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->MICROS = new \codename\parquet\format\MicroSeconds();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->NANOS = new \codename\parquet\format\NanoSeconds();
