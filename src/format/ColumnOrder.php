...
class ColumnOrder
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\TypeDefinedOrder',
        ),
    );
     ...
     * 
     * @var \codename\parquet\format\TypeDefinedOrder
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->TYPE_ORDER = new \codename\parquet\format\TypeDefinedOrder();
