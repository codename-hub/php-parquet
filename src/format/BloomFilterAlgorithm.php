...
class BloomFilterAlgorithm
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\codename\parquet\format\SplitBlockAlgorithm',
        ),
    );
     ...
     * 
     * @var \codename\parquet\format\SplitBlockAlgorithm
     */
    public $BLOCK = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->BLOCK = new \codename\parquet\format\SplitBlockAlgorithm();
